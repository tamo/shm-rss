# [セキュmemo](https://www.st.ryukoku.ac.jp/~kjm/security/memo/) のRSS生成

## [shm.rb](https://github.com/tamo/shm-rss/blob/main/shm.rb)
...
## [shm.ts](https://github.com/tamo/shm-rss/blob/main/shm.ts)
https://shm-rss.deno.dev/ に生成しています。

こちらは Deno 環境の TypeScript です。
Deno Deploy にこのファイルをコピペするだけで使えます。
